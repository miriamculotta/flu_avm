...
import "../../../config/entities/pokemon.dart";

class PokemonScreen extends ConsumerWidget {
  final String pokemonId;
  const PokemonScreen({required this.pokemonId, super.key});
  @override
...
class _PokemonVisum extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(pokemon.nomen)),
      body: Center(
        child: Column(
...
class _ErrorWidget extends StatelessWidget {
  final nuntius;
  const _ErrorWidget({required this.nuntius});

  @override
  Widget build(BuildContext context) {
    return Scaffold(body: Center(child: Text('Error: $nuntius')));
  }
}
